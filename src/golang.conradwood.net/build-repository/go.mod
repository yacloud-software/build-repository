...
require (
	...
	golang.conradwood.net/apis/deployminator v1.1.1466
	golang.conradwood.net/apis/registry v1.1.1466
	golang.conradwood.net/apis/slackgateway v1.1.1466
	golang.conradwood.net/go-easyops v0.1.10750
...
require (
	...
	golang.conradwood.net/apis/auth v1.1.1464 // indirect
	golang.conradwood.net/apis/autodeployer v1.1.1464 // indirect
	golang.conradwood.net/apis/deploymonkey v1.1.1464 // indirect
	golang.conradwood.net/apis/echoservice v1.1.1464 // indirect
	golang.conradwood.net/apis/errorlogger v1.1.1464 // indirect
	golang.conradwood.net/apis/framework v1.1.1464 // indirect
	golang.conradwood.net/apis/h2gproxy v1.1.1466 // indirect
	golang.conradwood.net/apis/objectstore v1.1.1504 // indirect
	golang.conradwood.net/apis/rpcinterceptor v1.1.1464 // indirect
