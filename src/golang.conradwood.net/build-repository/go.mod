...
require (
	...
	golang.conradwood.net/apis/common v1.1.2720
	golang.conradwood.net/apis/deployminator v1.1.2643
	golang.conradwood.net/apis/deploymonkey v1.1.2643
	...
	golang.yacloud.eu/apis/buildrepoarchive v1.1.2643
...
require (
	...
	golang.conradwood.net/apis/auth v1.1.2720 // indirect
	...
	golang.conradwood.net/apis/goeasyops v1.1.2720 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.2720 // indirect
