...
require (
	...
	golang.conradwood.net/apis/deployminator v1.1.1549
	golang.conradwood.net/apis/registry v1.1.1728
	golang.conradwood.net/apis/slackgateway v1.1.1549
	golang.conradwood.net/go-easyops v0.1.12713
	golang.org/x/net v0.0.0-20220615171555-694bf12d69de
	golang.yacloud.eu/apis/buildrepoarchive v1.1.1549
...
require (
	...
	golang.conradwood.net/apis/h2gproxy v1.1.1549 // indirect
